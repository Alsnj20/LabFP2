...
public class Ejercito {
    ...
    public Ejercito(Graphic game, String name, Soldado[][] t, boolean buffed){
        nameArmy = name;
        ...
        switch (dir) {
            ...
            case "der":
                ...
                if (der > table.length)
                    ...
                    w.setFila(row);w.setColumna(der);
                break;
            case "arr":
                int arr = row - n;
                if (arr < 0)
                    ...
                    w.setFila(arr);w.setColumna(col);
                break;
            case "aba":
                int aba = row + n;
                if (aba > table.length)
                    ...
                    w.setFila(aba);w.setColumna(col);
                break;
        }
        return w;
    }
