...
public class Videojuego9 {
        ...
        while (play) {
            ...
            switch (option){
                case 1: playGame(navy1, navy2);
                        break;
                case 2: fillSoldier(navy1, navy2, generateSoldier());
                        fillSoldier(navy2, navy1, generateSoldier());
    ...
    public static void playGame(Soldado[][] navy1, Soldado[][] navy2) {
        ...
        String answer = "";
        while (true) {
            fillSoldier(navy1, navy2, generateSoldier());
            fillSoldier(navy2, navy1, generateSoldier());
    ...
    public static void playAction(Soldado[][] navy1, Soldado[][] navy2){
        ...
        while (true) {
            ...
            displaySoldierNavy(navy1, navy2);
            if (countSoldiers(navy1) == 0 || countSoldiers(navy2) == 0)
                break;
    ...
    public static void fillSoldier(Soldado[][] army1, Soldado[][] army2, int n) {
